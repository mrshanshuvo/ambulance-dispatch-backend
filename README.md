...
| `GET`   | `/`           | ADMIN/DRIVER | List dispatches (Admin sees fleet, Driver sees history) |
...
| `GET`  | `/my`                  | PATIENT/ADMIN | Payment history (Patient: personal, Admin: fleet) |
...
| `GET`    | `/audit-logs`       | ADMIN | View audit trail (`?action=&entityType=`)          |
