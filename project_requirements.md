...
- **Payment Integration**: This is **MANDATORY**. You must integrate **bKash, Stripe, or SSLCommerz**. Your system must securely handle payment creation, success/cancellation callbacks, and status tracking. _Cash on Delivery, Pay Later, or fake manual status updates are NOT accepted._
